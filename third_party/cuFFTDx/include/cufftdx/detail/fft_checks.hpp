...
namespace cufftdx {
    namespace detail {
        ...
        class is_supported_helper
        {
            ...
            static constexpr bool is_ept_supported_v =
                !CUFFTDX_STD::is_void<typename database::detail::query_database<ptx_backend.size,
                                                                                ptx_backend.type,
                                                                                ...
                                                                                Precision,
                                                                                Code>::selected_block_config_t>::value;
            ...
            static constexpr bool is_ept_supported_blue_v =
                !CUFFTDX_STD::is_void<typename database::detail::query_database<ptx_blue_backend.size,
            ...
            static constexpr bool is_lto_supported = !((Code == experimental::code_type::ltoir) && !CUFFTDX_STD::is_void<BlockDimension>::value);

        public:
            static constexpr bool value =
                is_lto_supported &&                                                                            // LTO support
