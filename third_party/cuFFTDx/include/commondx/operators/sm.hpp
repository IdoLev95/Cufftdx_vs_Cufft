...
namespace commondx {
    ...
    namespace detail {
        ...
        constexpr unsigned forward_sm_if_compatible() {
            ...
            static_assert(Architecture != 1010 or __CUDACC_VER_MAJOR__ <= 12, "Incorrect SM<1010> value, use SM<1100> instead. In CUDA 13 sm_101 (Thor) was renamed to sm_110");
            static_assert(Architecture != 1100 or __CUDACC_VER_MAJOR__ >= 13, "Incorrect SM<1100> value, use SM<1010> instead. In CUDA 13 sm_101 (Thor) was renamed to sm_110");
        #endif
